...
//Validatate incoming user details
...
func (account *Account) Validate() (map[string]interface{}, bool) {
	...
	return utils.Message(false, "Requirement passes"), true
}
...
func (account *Account) Create() map[string]interface{} {
	...
	if account.ID <= 0 {
		return utils.Message(false, "Failed to create account, connection ")
	}
	...
	response := utils.Message(true, "Account has been creted")
